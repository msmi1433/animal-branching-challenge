...
do
{
    ...
    switch (menuSelection)
    {
        ...
        case "3":
            ...
            for (int i = 0; i < maxPets; i++)
            {
                ...
                if (ourAnimals[i, 4] == "Physical description: " && ourAnimals[i, 0] != "ID #: ")
                {
                    do
                    {
                        ...
                        if (readResult != null)
                        {
                            animalPhysicalDescription = readResult.ToUpper();
                            if (animalPhysicalDescription != "")
                            {
                                validEntry = true;
                            }
            ...
            Console.WriteLine("Animal records are now complete!");
            ...
            for (int i = 0; i < maxPets; i++)
            {
                if (ourAnimals[i, 0] != "ID #: " && ourAnimals[i, 3] == "Nickname: ")
                {
                    do
                    {
                        ...
                        if (readResult != null)
                        {
                            animalNickname = readResult.ToUpper();
                            if (animalNickname != "")
                            {
                                validEntry = true;
                            }
                ...
                if (ourAnimals[i, 0] != "ID #: " && ourAnimals[i, 5] == "Personality: ")
                {
                    do
                    {
                        Console.WriteLine($"Please enter a personality type for {ourAnimals[i, 0]}");
                        readResult = Console.ReadLine();
                        if (readResult != null)
                        {
                            animalPersonalityDescription = readResult.ToUpper();
                            if (animalPersonalityDescription != "")
                            {
                                validEntry = true;
                            }
